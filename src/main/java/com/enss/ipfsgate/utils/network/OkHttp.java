...
public class OkHttp {
     ...
     * @return
     */
    public static Response doGetPublicHeader(String url,Map<String,String> map,String token){
        url += "?";
        for (String key:map.keySet()) {
            url += key+"="+map.get(key)+"&";
        }
        url = url.substring(0,url.length()-1);
        System.out.println(url);
        return mInstance.inner_DoGetPublicHeader(url,token);
    }
     ...
     * @return
     */
    private Response inner_DoGetPublicHeader(String url,String token){
...
//     * @return
//     */
//    public static Response doPostPublicHeader(String url, Map<String,String> map,String token){
//
//        RequestBody requestBody = mInstance.setRequestBody(map);
...
//     * @return
//     */
//    private Response inner_DoPostPublicHeader(String url,RequestBody requestBody,String token){
//
//        Request request = new Request.Builder()
//                .header("Content-Type","application/json")
//                .header("token",token)
...
//    }
     ...
     * @return
     */
    public static Response doPostPublicHeader(String url, Map<String,String> map,String token) throws Exception {
     ...
     * @return
     */
    private Response inner_DoPostPublicHeader(String url,RequestBody requestBody,String token) throws Exception{

        Headers headers = new Headers.Builder().add("token",token)
                .build();

        Request request = new Request.Builder()
                .post(requestBody).url(url).headers(headers).build();
